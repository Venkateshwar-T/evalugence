          ...
          <>
            ...
            >
              ...
              <div 
                ...
                className={`hidden md:flex absolute left-0 top-0 bottom-0 w-3 cursor-ew-resize transition-colors z-[10002] flex items-center justify-center -ml-1.5 group/drag ${isDragging ? 'bg-blue-500/20' : 'hover:bg-blue-500/10'}`}
              >
                ...
                <div className="absolute top-1/2 -translate-y-1/2 right-full mr-2 px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-xs rounded-xl opacity-0 group-hover/drag:opacity-100 invisible group-hover/drag:visible transition-all whitespace-nowrap shadow-2xl z-50 pointer-events-none">Drag to resize</div>
              </div>
