          ...
          <>
            ...
            >
              ...
              <div 
                ...
                className={`absolute left-0 top-0 bottom-0 w-3 cursor-ew-resize transition-colors z-[201] flex items-center justify-center -ml-1.5 group/drag ${isDragging ? 'bg-blue-500/20' : 'hover:bg-blue-500/10'}`}
              >
